...
const KEYWORDS = [_]Keyword{
    ...
    .{ .word = "double", .kind = .kw_double },
    .{ .word = "desc", .kind = .kw_desc },
    .{ .word = "check", .kind = .kw_check },
    ...
    .{ .word = "smallint", .kind = .kw_smallint },
    .{ .word = "string", .kind = .kw_string },
    .{ .word = "struct", .kind = .kw_struct },
    .{ .word = "table", .kind = .kw_table },
    .{ .word = "text", .kind = .kw_text },
    .{ .word = "tinyint", .kind = .kw_tinyint },
